...
struct qt_meta_stringdata_CLASSProfileWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSProfileWidgetENDCLASS = QtMocHelpers::stringData(
    "ProfileWidget",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSProfileWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ProfileWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSProfileWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSProfileWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSProfileWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ProfileWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSProfileWidgetENDCLASS.stringdata0))
