...
struct qt_meta_stringdata_CLASSDatabaseControllerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDatabaseControllerENDCLASS = QtMocHelpers::stringData(
    "DatabaseController"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDatabaseControllerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DatabaseController::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDatabaseControllerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDatabaseControllerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDatabaseControllerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *DatabaseController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDatabaseControllerENDCLASS.stringdata0))
