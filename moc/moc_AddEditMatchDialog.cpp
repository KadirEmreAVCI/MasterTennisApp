...
constexpr auto qt_meta_stringdata_CLASSAddEditMatchDialogENDCLASS = QtMocHelpers::stringData(
    ...
    "statu",
    "on_comboBox_Stage_currentTextChanged",
    "stage",
    "SetMatchDate",
    "date"
);
...
Q_CONSTINIT const QMetaObject AddEditMatchDialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAddEditMatchDialogENDCLASS_t,
        ...
        // method 'on_comboBox_Stage_currentTextChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
        // method 'SetMatchDate'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void AddEditMatchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->on_radioButton_Win_clicked(); break;
        case 5: _t->on_radioButton_Lose_clicked(); break;
        case 6: _t->on_comboBox_Statu_currentTextChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 7: _t->on_comboBox_Stage_currentTextChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
