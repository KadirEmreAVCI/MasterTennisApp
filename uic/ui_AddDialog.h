...
public:
    ...
    QRadioButton *radioButton_Match;
    ...
    void setupUi(QDialog *AddDialogClass)
    {
        ...
        radioButton_Match = new QRadioButton(AddDialogClass);
        radioButton_Match->setObjectName("radioButton_Match");

        verticalLayout->addWidget(radioButton_Match);
    ...
    void retranslateUi(QDialog *AddDialogClass)
    {
        ...
        radioButton_Match->setText(QCoreApplication::translate("AddDialogClass", "Match", nullptr));
