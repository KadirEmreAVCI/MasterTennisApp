...
private:
	...
	std::unique_ptr<StatWidget> m_upMatchesStatWidget;
	std::unique_ptr<StatWidget> m_upMatchTiebreaksStatWidget;
	std::unique_ptr<StatWidget> m_upSetTiebreaksStatWidget;
};
