...
void AppController::StartApplication()
{
	...
	Organization::SetPictureRootDestDir(QCoreApplication::applicationDirPath() + "/../../src/app/resources/organizations/");
	Profile::SetPictureRootDestDir(QCoreApplication::applicationDirPath() + "/../../src/app/resources/profiles/");
