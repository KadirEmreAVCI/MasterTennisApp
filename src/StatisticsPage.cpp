...
void StatisticsPage::InitStatIcons()
{
	...
	InitPicture(ui.label_IconTournament, ":images/images/crossed_swords.png", 1.0f);
	InitPicture(ui.label_IconMatches, ":images/images/games.png", 1.0f);
	InitPicture(ui.label_IconSetTB, ":images/images/setTB.png", 1.0f);
	InitPicture(ui.label_IconSuperTB, ":images/images/clutchness.png", 1.0f);
	InitPicture(ui.label_IconQuarterFinals, ":images/images/trophy.png", 0.9f);
	InitPicture(ui.label_IconSemiFinals, ":images/images/trophy.png", 0.9f);
	InitPicture(ui.label_Icon3rdPlaceMatch, ":images/images/trophy.png", 0.9f);
	InitPicture(ui.label_IconFinals, ":images/images/trophy.png", 0.9f);
	InitPicture(ui.label_Icon1stPlace, ":images/images/first_place.png", 3.0f);
	InitPicture(ui.label_Icon2ndPlace, ":images/images/second_place.png", 3.0f);
	InitPicture(ui.label_Icon3rdPlace, ":images/images/third_place.png", 3.0f);
	InitPicture(ui.label_IconAchievements, ":images/images/achievements_page.png", 12.0f);
}
...
void StatisticsPage::SetWLStat(WinLoseLabels wlLabels, WinLoseStat wlstat)
{
